...
public class frmBuscador extends javax.swing.JFrame {
    ...
    MtoGastosMateriales mat = new MtoGastosMateriales();
    ...
    /**
     * Metodo para completar las columnas de la tabla y cargar los correspondientes datos
     * @param formulario nombre del formulario para identificar desde que formulario se accedio
     */
    ...
    /**
     * Metodo para cargar los datos en los textfields al seleccionar una fila de la tabla
     ...
     * @param formulario formulario para saber que dato debe buscarse(Distincion)
     */
    ...
    {    
     ...
     /**
     * Metodo prara escribir registro en textfield segun el formulario desde el que se accedio
     * @param dato cadena de texto que se colocara en el textfield del otro form
     * @param formulario formulario en el cual se ingresaran los datos (Distincion)
     */
