...
public class Funciones {
    ...
    /**
     * Metodo para agregar un guion automaticamente al textfield segun numero de
     * caracteres
     *
     ...
     */
    public void separarEncargado(JTextField jTF, Asignaciones obj) {
        nombre = "";
        apellido = "";
        texto = jTF.getText();
        palabra = 1;
     ...
     * @param obj objeto de la clase donde se guardaran los resultados
     */
    public void separarCliente(JTextField jTF, Proyecto obj) {
        nombre = "";
        apellido = "";
        texto = jTF.getText();
        palabra = 1;
    ...
    // Metodo para validar que solo se ingresen letras y no se supere la longitud maxima
    ...
    // Metodo para validar que solo se ingresen numeros y no se supere la longitud maxima
