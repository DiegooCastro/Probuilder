...
import Views.Frames.frmFileChooser;
 ...
 * @author Diego Castro
 */
public class Imagen extends Database {
    ...
    /**
     * Metodo para mostrar el selector de archivos y para cargar la imagen
    ...
    /**
     * Metodo para convertir una cadena de bytes a un ImageIcon para colocarlo
     * como imagen en un JLabel
     *
     ...
     * como imagen en un JLabel
     *
     * @param ruta es la ruta relativa de la ubicacion de la imagen que se desea
     * convertir a bytes[]
     * @return
     */
    ...
    public boolean ingresarImagen(Imagen img) {
        try {
