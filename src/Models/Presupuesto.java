 ...
 * @author Diego
 */
public class Presupuesto extends Database {
    ...
    public String[] cargarPresupuesto(Presupuesto var) {
    ...
    public boolean actualizarTotales(Presupuesto var) {
    ...
    public boolean actualizarGatosPreliminares(Presupuesto var) {
        boolean retorno = false;
        try {
    ...
    public boolean actualizarManoObra(Presupuesto var) {
        boolean retorno = false;
        try {
    ...
    public boolean actualizarGastoMaterial(Presupuesto var) {
        boolean retorno = false;
        try {
