 ...
 * @author Diego
 */
public class Asignaciones extends Database {

    PreparedStatement ps;
    ResultSet rs;

    public boolean ingresarAsignacion(Asignaciones obj) {
    ...
    public boolean modificarAsignacion(Asignaciones obj, int id) {
        boolean retorno = false;
        boolean estado = true;
    ...
    public boolean modificarEstadoAsignacion(Asignaciones obj, int id) {
        boolean retorno = false;
        try {
