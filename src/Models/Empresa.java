 ...
 * @author Diego Castro
 */
public class Empresa extends Database {
     ...
     */
    public boolean ingresarEmpresa(Empresa var) {
     ...
     * @return variable de tipo boolean que confirma si se realizo la consulta
     */
    public boolean modificarEmpresa(Empresa var) {
        boolean respuesta = false;
        try {
    ...
    /**
     * Metodo para cargar los datos de la primer empresa e ingresarlos en el
     * formulario primer uso
     *
     * @param var objeto de la clase para mandar a llamar los metodos
     * @return resultado de la ejecucion de la consulta
     */
    public boolean cargarSucursal(Empresa var) {
        boolean respuesta = false;
        try {
