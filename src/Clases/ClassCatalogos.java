...
public class ClassCatalogos 
{
    ...
    public boolean ingresarCatalogo(ClassCatalogos obj,String queryValidar,String queryIngresar)
    {
        retorno = false;
        try
        {
            ps = con.getConnection().prepareStatement(queryValidar);
            ...
            {
                ps = con.getConnection().prepareStatement(queryIngresar);
                ps.setString(1, obj.getRegistro());
                if (!ps.execute()) 
                {              
                    retorno = true;
    ...
    public boolean modificarCatalogo(ClassCatalogos obj,String queryModificar)
    {
        retorno = false;
        try
        {
            ps = con.getConnection().prepareStatement(queryModificar);
            ps.setString(1, obj.getRegistro());
